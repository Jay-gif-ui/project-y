...
export function WishlistPage() {
  ...
  if (!user) return <main className="shell wishlist-page"><p className="eyebrow">Your list</p><h1>Sign in to see your wishlist</h1><Link href="/login?next=%2Fwishlist" className="primary-link">Sign in</Link></main>;
