...
export type Media = { id:number; mediaType:MediaType; title:string; overview:string; posterPath?:string; backdropPath?:string; releaseDate?:string; popularity?:number; rating:number; voteCount:number; genreIds:number[] };
